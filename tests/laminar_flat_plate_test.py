...
def test_laminar_flat_plate():
    ...
    msh.gr.calculate(ends=['closure', 'p', 'uw', 'thetastar', 'deltaprime', 'Cf', 'Cd', 'J', 'M', 'E', 'rhoQ', 'D'])

    tdiff=tm.time()

    qx_derivs=msh.gr.get_derivs_direct('qx', ends=['closure', 'p', 'uw', 'thetastar', 'deltaprime', 'Cf', 'Cd', 'J', 'M', 'E', 'rhoQ', 'D'])
