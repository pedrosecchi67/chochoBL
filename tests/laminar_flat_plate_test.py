...
def test_laminar_flat_plate():
    ...
    msh.gr.calculate(ends=['thetastar', 'deltaprime', 'Cd', 'E', 'rhoQ', 'D', 'tau', 'Rmass', 'RTS', 'Rmomx', 'Rmomz'])

    tdiff=tm.time()

    qx_derivs=msh.gr.get_derivs_direct('qx', ends=['thetastar', 'deltaprime', 'Cd', 'E', 'rhoQ', 'D', 'tau', 'Rmass', 'RTS', 'Rmomx', 'Rmomz'])
